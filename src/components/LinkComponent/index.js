export default function LinkComponent({ title, goto, lang, enTitle }) {
  return (
    <li className="p-5">
      <a
        href={goto}
      ...
      >
        {lang === 'pt-br' ? <span className="relative z-10 group-hover:text-black duration-1000 text-xl">{title}</span> : <span className="relative z-10 group-hover:text-black duration-1000 text-xl">{enTitle}</span>}
