...
export default function Card({ title, description, gitUrl, liveUrl, printUrl, node, java, javascript, springboot, mongo, discord, python, html, css, tailwind, typescript, react }) {
  return (
    <div className="border-solid border-victorViolet border-2 rounded-tl-3xl rounded-md items-center justify-center flex-row max-w-md self-center place-self-center hover:-translate-y-6 transition-all text-center">
